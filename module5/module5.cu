 ...
 * allocMem
 */
void allocMem(float** inputs, float** weights, float** outputs, float** outputsConst,
...
int main(int argc, char* argv[]) {
	...
	float *inputs, *weights, *outputs, *outputsConst,
	...
	allocMem(&inputs, &weights, &outputs, &outputsConst,
					 (void**)&inputsPinned, (void**)&weightsPinned, (void**)&outputsPinned, 
					 &d_inputs, &d_weights, &d_outputs,
					 inputSize, gridSize);
