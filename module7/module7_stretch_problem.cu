				...
				const unsigned int tid)
{
	...
	//PLACE YOUR CODE HERE
	// NEW CODE
	// The method that calls this says that this should be a 
	// "GPU REGISTER OPERATION"
	// Therefore, I will compute the operation in register memory
	int element = data[tid];
	data[tid] = element * element;
	// NEW CODE
}
